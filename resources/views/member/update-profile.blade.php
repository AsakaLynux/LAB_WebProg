...
<div class="bg-black mx-auto mt-5 rounded actordetails-content">
    ...
    <div class="d-flex p-5">
        <div class="d-flex flex-column me-5">
            ...
            <button type="button" class="btn rounded-circle" data-bs-toggle="modal" data-bs-target="#updateModal"><img class="rounded-circle mt-3 mx-auto" src="../{{$user->image_url != null ? $user->image_url : '../storage/images/assets/profile-pict.jpg'}}" width="100" height="100" alt=""></button>

...
<div class="d-flex justify-content-center">
    <form class="text-white form-width bg-dark rounded p-3">
        <div class="mb-3">
            <label for="" class="form-label">Username</label>
            <input type="email" class="form-control bg-secondary text-white" id="exampleInputUsername1" aria-describedby="emailHelp">
          </div>
        <div class="mb-3">

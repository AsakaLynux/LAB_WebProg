...
<body>
    ...
    <form action="/update-movie" enctype="multipart/form-data" method="POST">
        ...
        <input type="text" name="genre" placeholder="{{$movies->genre}}">

        <label for="actor">Actor</label>
        <input type="text" name="actor" placeholder="{{$movies->actor}}">

        <label for="character-name">Character Name</label>
        <input type="text" name="character_name" placeholder="{{$movies->character_name}}">

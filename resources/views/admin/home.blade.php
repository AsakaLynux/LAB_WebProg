...
<div id="carouselExampleCaptions" class="carousel slide">
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="mx-3">
            ...
            <a class="cover-text" href="/detail-movies/{{$movie->id}}">
    ...
    <div class="d-flex mx-3 mt-3 text-white">
        <a href="/create-movie"><button class="btn btn-danger"><img width="20" height="20"
                    src="storage/images/assets/plus-btn.png" alt=""> Add Movie</button></a>
    </div>
    <div class="d-flex justify-content-center">
        @foreach ($movies as $movie)
        <div class="mx-3">
